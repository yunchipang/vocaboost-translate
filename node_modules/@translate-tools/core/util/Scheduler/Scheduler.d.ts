...
import { langCode, langCodeWithAuto, TranslatorInstanceMembers } from '../../types/Translator';
interface Config {
    /**
...
export declare class Scheduler implements IScheduler {
    ...
    translate(text: string, from: langCodeWithAuto, to: langCode, options?: ITranslateOptions): Promise<string>;
